...
开源 Community Edition：面试准备 skills、岗位知识库、工作台数据契约、本地参考后端和虚构示例工作台。**本仓库不含产品界面。**官方产品在 [greenroom.ungetsu.net](https://greenroom.ungetsu.net/)，它的前端、账号同步、托管服务端和品牌资产都不在本仓库。结构见 [README.md](README.md)，数据契约见 [docs/workspace-spec.md](docs/workspace-spec.md)。许可证为 AGPL-3.0；品牌使用见 [TRADEMARK.md](TRADEMARK.md)。
...
- `./start.sh ~/some-workspace` 起本地后端，`curl http://127.0.0.1:8765/workspace/bundle` 能拿到工作台全文
